    ...
    <main id="profile" className="max-w-screen min-h-screen bg-[rgb(83,18,32)] flex items-center justify-center p-6">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex flex-col justify-center items-start text-white gap-3">
          ...
          <a href="/CV-ClarestaElysia.pdf" download="CV-ClarestaElysia.pdf" className="px-6 py-3 bg-black text-white rounded-full hover:bg-white hover:text-black transition-all">
            Download CV
          </a>
        </div>
      </div>
